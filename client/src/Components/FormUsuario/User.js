	...
	return (
		<div>
			...
			{user.id ? (
				...
				<div className='userData'>
					...
					<button className='deleteAcc' onClick= {handleClickOpen}>Eliminar Cuenta</button>
					<Dialog
        open={open}
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={() => {deleteUsers(user.id); handleClose()}} color="primary">
            Aceptar
          </Button>
        </DialogActions>
      </Dialog>
